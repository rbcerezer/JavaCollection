package edu.dio.collection.streamapi;
...
public class StreamAPI {
    public static void main(String[] args) {
        ...
        System.out.println("- Pegue os 5 primeiros numeros e coloque dentro se um Set: ");
        ...
        List<Integer> ListaParesMaiorDe2 = numerosAleatorios.stream()
                .map(Integer::parseInt)
                .filter(i -> (i % 2 == 0 && i > 2))
                .collect(Collectors.toList());
        System.out.println(ListaParesMaiorDe2);

        System.out.println("- Mostre a média dos números");
        OptionalDouble numerosAleatoriosInteger = numerosAleatorios.stream()
                .mapToInt(Integer::parseInt)
                .average();
        numerosAleatoriosInteger
